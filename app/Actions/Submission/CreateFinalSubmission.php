...
class CreateFinalSubmission
{
    ...
    public function handle(
        ...
        DB::transaction(function () use ($submission, $recommendation, $revisedAbstract, $extendedAbstract, $poster) {
    ...
    private function createSubmissionFinalRound(Submission $submission): SubmissionRound
    {
        return SubmissionRound::create([
            'submission_id' => $submission->id,
            'round_type' => SubmissionRoundType::FINAL,
        ]);
    }
}
