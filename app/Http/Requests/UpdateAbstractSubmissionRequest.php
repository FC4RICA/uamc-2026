...
class UpdateAbstractSubmissionRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'participants.*.firstname.required' => 'กรุณากรอกชื่อจริง',
            'participants.*.firstname.string' => 'ชื่อจริงต้องเป็นข้อความ',
            'participants.*.firstname.max' => 'ชื่อจริงยาวเกินกำหนด',

            'participants.*.lastname.required' => 'กรุณากรอกนามสกุล',
            'participants.*.lastname.string' => 'นามสกุลต้องเป็นข้อความ',
            'participants.*.lastname.max' => 'นามสกุลยาวเกินกำหนด',

            'participants.*.phone.string' => 'หมายเลขโทรศัพท์ต้องเป็นข้อความ',
            'participants.*.phone.max' => 'หมายเลขโทรศัพท์ยาวเกินกำหนด',
