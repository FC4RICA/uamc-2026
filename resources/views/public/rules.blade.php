...
<div class="container my-5">
    ...
    <ol>
        ...
        <li>
            <strong>บทคัดย่อภาษาอังกฤษ</strong>&nbsp;(MS Word+PDF) ความยาวไม่เกิน 1 หน้ากระดาษ A4 ตาม template ที่กำหนดให้
        </li>
    </ol>
    ...
    <ol start="3">
        <li>
            <strong>บทคัดย่อแบบขยาย</strong>&nbsp;(extended abstract) (MS Word หรือ PDF) ความยาวไม่เกิน 5 หน้ากระดาษ A4 ตาม template ที่กำหนดให้<br />
    ...
    <ol>
        <li>
            <strong>บทคัดย่อภาษาไทย</strong>&nbsp;(MS Word+PDF) ความยาวไม่เกิน 1 หน้ากระดาษ A4 ตาม template แบบเดียวกับรูปแบบบรรยาย
        </li>
        <li>
            <strong>บทคัดย่อภาษาอังกฤษ</strong>&nbsp;(MS Word+PDF) ความยาวไม่เกิน 1 หน้ากระดาษ A4 ตาม template แบบเดียวกับรูปแบบบรรยาย
        </li>
    </ol>
</div>
