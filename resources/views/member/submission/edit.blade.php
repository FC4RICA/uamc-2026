...
<div class="container my-5">
    <div class="row">
        <div class="col-12 col-md-12 col-lg-12">
            <h2 class="text-center fw-bold">แก้ไขบทคัดย่อ</h2>
        </div>
    </div>
    <hr class="separator">
    <form id="editpaper" name="editpaper" action='{{ route('member.submission.update') }}' method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="text-center">
            <div class="form-group">
                ...
                <a href="" class="btn btn-danger">ลบบทคัดย่อ</a>
            </div>
        </div>
    </form>
</div>
