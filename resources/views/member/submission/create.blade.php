...
<div class="container px-4 mt-4 mb-5">
    ...
    <hr class="separator">
    {{-- @if($status == 1) --}}
    <form id="submitpaper" name="submitpaper" action='{{ route('member.submission.store') }}' method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
            <div class="col-12 col-lg-6 col-xl-4">
                <div class="form-group">
                    ...
                    <input id="category" name="category" type="text" class="form-control" disabled value="{{ $user_presentation_type->label() }}">
                    @error('category')
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-6 col-xl-4">
                <div class="form-group">
                    ...
                    <select id="category2" name="category2" class="form-select @error('category2') is-invalid @enderror">
            ...
            <div class="col-12 col-lg-6 col-xl-4">
                <div class="form-group">
                    ...
                    <select id="category3" name="category3" class="form-select @error('category3') is-invalid @enderror">
                        <option value="" selected disabled>เลือก (ไม่จำเป็น)</option>
                        <option value="">ไม่เลือก</option>
                        @foreach($groups as $group)
                            <option value="{{ $group->id }}">{{ $group->name}}</option>
            ...
            <div class="card-body row align-items-end">
                ...
                <div class="col-12 col-sm-6 col-xl-2">
                    <div class="form-group">
                        ...
                        <input id="user_academic_title" name="user_academic_title" value="{{ $profile->academic_title->label() }}"
                        class="form-control" disabled>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="form-group">
                        ...
                        <input id="user_phone" name="user_phone" value="{{ $profile->phone }}"
                        class="form-control" disabled>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-xl-3">
        ...
        <div class="text-center">
            <div class="form-group">
                <button class="btn btn-warning" type="submit" onclick="this.disabled=true; this.form.submit();">ส่งบทคัดย่อ</button>
            </div>
        </div>
    </form>
