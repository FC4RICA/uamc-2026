...
<div class="card mb-4 participant" data-participant>
    ...
    <div class="card-body row align-items-end">
        <div class="col-12 col-sm-6 col-xl-2 form-group">
            ...
            <select name="participants[{{ $index }}][title]" class="form-select" required>
        ...
        <div class="col-12 col-md-6 col-xl-4 form-group">
            <label>ชื่อ</label>
            <input type="text" name="participants[{{ $index }}][firstname]" class="form-control"
                value="{{ $p['firstname'] ?? '' }}" required>
        </div>

        <div class="col-12 col-md-6 col-xl-4 form-group">
            <label>นามสกุล</label>
            <input type="text" name="participants[{{ $index }}][lastname]" class="form-control"
                value="{{ $p['lastname'] ?? '' }}" required>
        </div>

        <div class="col-12 col-md-6 col-xl-3 form-group">
            <label>ระดับการศึกษา</label>
            <select name="participants[{{ $index }}][education]" class="form-select" required>
                <option value="" disabled>เลือก</option>
        ...
        <div class="col-12 col-md-6 col-xl-3 form-group">
            ...
            <input type="tel" name="participants[{{ $index }}][phone]" class="form-control"
            ...
            <div class="row align-items-end">
                ...
                <div class="col-12 col-xl-6">
                    <input type="text" name="participants[{{ $index }}][occupation_other]"
                        placeholder="กรุณาระบุอาชีพ" class="form-control" value="{{ $p['occupation_other'] ?? '' }}"
        ...
        <div class="col-12 col-md-6 form-group">
            ...
            <div class="row align-items-end">
                ...
                <div class="col-12 col-xl-6">
                    <input name="participants[{{ $index }}][organization_other]"
                        value="{{ $p['organization_other'] ?? '' }}" class="form-control" type="text"
                        placeholder="กรุณาระบุสถานที่ทำงาน" data-organization-other>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-md-6 form-group">
            ...
            <input name="participants[{{ $index }}][special_requirements]"
                value="{{ $p['special_requirements'] ?? '' }}" class="form-control"
