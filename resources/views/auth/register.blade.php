    ...
    <form action="{{ route('register') }}" name="registration-form" id="registration-form" method="POST">
        ...
        <div>
            ...
            <div class="form-group">
                ...
                class="form-control @error('email') is-invalid @enderror" placeholder="uamc2026@kmutt.ac.th" required>
                @error('email')
            ...
            <div class="form-group">
                ...
                class="form-control @error('password_confirmation') is-invalid @enderror" placeholder="ยืนยันรหัสผ่าน" required>
            </div>
        </div>
        <div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="form-group">
                        ...
                        <select id="academic_title" name="academic_title" class="form-select @error('academic_title') is-invalid @enderror" required>
        ...
        <div>
            ...
            <div class="row align-items-end">
                ...
                <div class="col-12 col-lg-6">
                    <div class="form-group">
                        <input id="occupation_other" name="occupation_other" value="{{ old('occupation_other') }}" type="text"
                            class="form-control @error('occupation_other') is-invalid @enderror" placeholder="กรอกอาชีพของคุณ"
            ...
            <div>
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-12 col-lg-6 ">
                        <div class="form-group">
                            <input id="organization_other" name="organization_other" value="{{ old('organization_other') }}" 
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="form-group">
                            ...
                            <select name="participation_type" id="participation_type" class="form-select 
                                @error('participation_type') is-invalid @enderror" required
                                data-toggle-select data-target="[data-presentation-type]" 
                ...
                <div class="row">
                    <div class="col-12 col-lg-6">
                        <div class="form-group">
                            ...
                            <input id="special_requirements" name="special_requirements" value="{{ old('special_requirements') }}" type="text" 
                            class="form-control @error('special_requirements') is-invalid @enderror" placeholder="เช่น มังสวิรัติ, ฮาลาล, แพ้ถั่ว, เบาหวาน">
