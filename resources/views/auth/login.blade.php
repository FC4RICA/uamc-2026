        ...
        <div class="row justify-content-center">
            <form action="{{ route('login') }}" name="login" id="login-form" method="POST" class="col-12 col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <input id="email" name="email" type="email" placeholder="uamc2026@kmutt.ac.th"
                        autocomplete="username" class="form-control @error('email') is-invalid @enderror" required>
                    @error('email')
